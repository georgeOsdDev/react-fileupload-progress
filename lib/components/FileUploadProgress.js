...
var FileUploadProgress = function (_React$Component) {
  ...
  _createClass(FileUploadProgress, [{
    ...
    key: 'onFileClick',
    value: function onFileClick() {
      this.refs.input.click();
    }
  }, {
    key: 'render',
    value: function render() {
      var formElement = this.props.formRenderer(this.onSubmit.bind(this), this.onFileClick.bind(this));
    ...
    value: function _getFormData() {
      ...
      return new FormData(_react2.default.findDOMNode(this.refs.form));
    }
  }, {
    key: '_doUpload',
